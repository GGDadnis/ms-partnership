...
namespace mspartnership.Migrations
{
    ...
    [Migration("20230115160221_InitialCreate")]
            ...
            modelBuilder.Entity("ms_partnership.Models.Entities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e4af91f7-6744-4550-8f16-b6224c8e7e75"),
                        ...
                        new
                        {
                            Id = new Guid("9fbae565-0091-4a22-845f-f0543e5109d8"),
                        ...
                        new
                        {
                            Id = new Guid("3992e730-ea4a-4280-9178-797c94d5bb6e"),
                            Bairro = "Mooca",
                            Cep = "03162160",
                        ...
                        new
                        {
                            Id = new Guid("a6ea55ed-f3c5-4bf0-be7b-084eb3c88ba0"),
                            Bairro = "Centro",
                            Cep = "20080020",
                            CompanyId = new Guid("80d66e15-8c2c-4420-a0ef-5d40d050d52c"),
                            Complemento = "",
                        ...
                        new
                        {
                            Id = new Guid("95e28ea0-3608-48f3-ba1e-1d5c8d58f646"),
                            Bairro = "Diagon Alley",
                            Cep = "North Side",
                        ...
                        new
                        {
                            Id = new Guid("d20ef20c-fe08-4341-a386-9e8d527ca846"),
                            Bairro = "Diagon Alley",
                            Cep = "North Side",
            ...
            modelBuilder.Entity("ms_partnership.Models.Entities.Promo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1d740c32-afe1-4137-aab0-a4843b398fe0"),
                            CompanyId = new Guid("80d66e15-8c2c-4420-a0ef-5d40d050d52c"),
                            Condition = false,
                            Discount = 0.0,
                        ...
                        new
                        {
                            Id = new Guid("715680b7-00d4-448a-b892-7cd61a3e57cc"),
                            CompanyId = new Guid("43b478b0-8667-4c05-a905-dcb00b7cd976"),
                            Condition = true,
                            Discount = 50.0,
                            DiscountDescription = "HOT DEAL: Firebolt at 50% OFF",
                            EndDate = new DateTime(2023, 1, 20, 16, 2, 21, 67, DateTimeKind.Utc).AddTicks(7673),
                            StartDate = new DateTime(2023, 1, 15, 16, 2, 21, 67, DateTimeKind.Utc).AddTicks(7671)
                        },
                        new
                        {
                            Id = new Guid("8af2d467-d7d8-4b3f-9ac1-34102d4585e2"),
                            CompanyId = new Guid("43b478b0-8667-4c05-a905-dcb00b7cd976"),
                            Condition = false,
                            Discount = 10.0,
                            DiscountDescription = "Everything with 10% OFF",
                            StartDate = new DateTime(2023, 1, 20, 16, 2, 21, 67, DateTimeKind.Utc).AddTicks(7682)
                        },
                        new
                        {
                            Id = new Guid("907bd72f-b890-4032-b6e2-3f137f6f6835"),
                            CompanyId = new Guid("f7418b55-cca4-4f03-badc-cf194f82b57c"),
                            Condition = true,
                            Discount = 30.0,
